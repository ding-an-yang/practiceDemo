...
@Data
@ApiModel("附件3-1 填充字符")
public class Enclosure03 {
  /* 附件3-1：交易合约电量表-峰谷分时电价用户 */
  @ApiModelProperty("附件3-1 年")
  private String year1;
  @ApiModelProperty("附件3-1 月")
  private String month1;
  @ApiModelProperty("附件3-1 尖峰")
  private String peak1;
  @ApiModelProperty("附件3-1 高峰")
  private String height1;
  @ApiModelProperty("附件3-1 低谷")
  private String trough1;
  @ApiModelProperty("附件3-1 年")
